...
class Settings(BaseSettings):
    ...
    ocr_docling_fallback_engine: str = "rapidocr"
    ocr_quality_routing_enabled: bool = True
    ocr_quality_sample_pages: int = 3
    ocr_postprocess_enabled: bool = True
    ocr_symspell_enabled: bool = True
    ocr_rules_enabled: bool = True
    ocr_escalation_enabled: bool = True
    ocr_escalation_provider: str = "glm_ocr"
    ocr_medical_wordlist_path: str = ""
    glm_ocr_base_url: str = ""
    glm_ocr_api_key: str = ""
    glm_ocr_model: str = ""
    glm_ocr_timeout_seconds: int = 120
