...
class PaperChunk(Base):
    ...
    id: Mapped[int] = mapped_column(bigint_sqlite, primary_key=True, autoincrement=True)
    paper_id: Mapped[int] = mapped_column(bigint_sqlite, ForeignKey("papers.id", ondelete="CASCADE"), nullable=False)
    parent_chunk_id: Mapped[int | None] = mapped_column(bigint_sqlite, ForeignKey("paper_chunks.id", ondelete="SET NULL"))
    chunk_index: Mapped[int] = mapped_column(Integer, nullable=False)
    chunk_role: Mapped[str] = mapped_column(String(32), nullable=False, default="child", server_default="child")
